...
ALIASES: dict[str, set[str]] = {
    ...
    # --- Ensembl / positional annotation (optional in source files) ---
    "ensembl_gene": {"ensemblgene", "ensemblgeneid", "ensg", "geneid", "ensemblgenes"},
    "ensembl_transcript": {"ensembltranscript", "ensembltranscriptid", "enst", "transcriptid"},
    "ensembl_protein": {"ensemblprotein", "ensemblproteinid", "ensp", "proteinid"},
    "protein_description": {"proteindescription", "proteinname", "description", "proteinnames"},
    "protein_length": {"proteinlength", "lengthprotein", "seqlength", "sequencelength"},
    "position_in_protein": {"positioninprotein", "proteinposition", "position", "aaposition", "residueposition", "possiteinprotein"},
    "peptide_start": {"peptidestart", "startinprotein", "peptidestartposition", "startposition"},
...
SAAP_FIELDS = {
    ...
    "protein_description", "protein_length",
    "position_in_protein", "peptide_start",
